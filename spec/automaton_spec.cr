...
describe Pegasus::Automata::Automaton do
  describe "#initialize" do
    it "Starts at state 0" do
      automaton = Pegasus::Automata::Automaton(Int32, Int32).new
...
describe Pegasus::Automata::UniqueAutomaton do
  describe "#initialize" do
    it "Has no state memorized" do
      automaton = Pegasus::Automata::UniqueAutomaton(Int32, Int32).new
